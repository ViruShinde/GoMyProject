...
public class ClientOnboardService extends ClientOnBoardPageableService implements CommonService<ClientOnboardTable> {
	...
	public List<TestDto> findFundsDetailsByClientAndRiskAggregator2(int clientId, int riskAggregatorId){
		return theClientOnboardRepository.findFundsDetailsByClientAndRiskAggregator2(riskAggregatorId,clientId);
	}
	...
	public Page getSearchDetails(Pageable pageable, String requestFor, String riskAggregatorId, String clientId, int pageNo, String sortField,
			String sortDir, String keyword, int recordSize) {
		// TODO Auto-generated method stub
		return theClientOnboardRepository.searchFundsDetailsByClientAndRiskAggregatorPageable(pageable, Integer.parseInt(riskAggregatorId), Integer.parseInt(clientId), keyword);
	}
}
